      ...
      >
        <Tab eventKey={0} title={<TabTitleText>Users</TabTitleText>}>
          <Form className="settings-form">
            ...
            <FormGroup label="Platform role" fieldId="new-user-role">
              <FormSelect
                id="new-user-role"
                value={newUser.role}
                onChange={(_e, v) => {
        ...
        <Tab eventKey={2} title={<TabTitleText>Kubeconfigs</TabTitleText>}>
          ...
          <Form className="settings-form">
            <FormGroup label="Group" fieldId="kubeconfig-upload-group">
              <FormSelect
            ...
            <FormGroup label="Display name" fieldId="kubeconfig-upload-name">
              <TextInput
            ...
            <FormGroup label="Kubeconfig file" fieldId="kubeconfig-upload-file">
              <input
