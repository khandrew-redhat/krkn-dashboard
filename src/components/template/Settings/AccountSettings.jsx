...
const AccountSettings = () => {
  ...
  const requireCurrent = !mustChange && (usernameChanged || passwordChanged);
  ...
  return (
    <section className="settings-page__account">
      <p className="settings-page__hint">
        Update your sign-in username and password. Current password is required
        when changing either, except on first login.
      </p>
      {submitError ? (
