...
export const SET_POD_DETAILS = "SET_POD_DETAILS";
export const CHECK_SCENARIO = "CHECK_SCENARIO";
export const TOGGLE_ROOT_MODAL = "TOGGLE_ROOT_MODAL";
export const SET_NAMESPACES = "SET_NAMESPACES";
export const GET_PODMAN_STATUS = "GET_PODMAN_STATUS";
...
export const SET_ES_CONNECTION_INFO = "SET_ES_CONNECTION_INFO";
export const SET_DATE_RANGE = "SET_DATE_RANGE";
export const SET_PAGINATION = "SET_PAGINATION";
export const NEXT_PAGE = "NEXT_PAGE";
export const PREVIOUS_PAGE = "PREVIOUS_PAGE";
export const SET_METRICS_PAGE = "SET_METRICS_PAGE";
export const SET_METRICS_PAGE_OPTIONS = "SET_METRICS_PAGE_OPTIONS";
...
export const SET_SUMMARY_DATE_RANGE = "SET_SUMMARY_DATE_RANGE";
export const SET_GROUP_BY = "SET_GROUP_BY";
export const COMPARISON_SET_DATA = "COMPARISON_SET_DATA";
export const SET_COMPARSION_SCENARIO_DATA = "SET_COMPARSION_SCENARIO_DATA";
export const SET_COMPARSION_CLOUD_INFRA_DATA =
  "SET_COMPARSION_CLOUD_INFRA_DATA";
export const SET_COMPARSION_CLOUD_TYPE_DATA = "SET_COMPARSION_CLOUD_TYPE_DATA";

/* AUTH */
export const AUTH_LOADING = "AUTH_LOADING";
export const AUTH_SET_USER = "AUTH_SET_USER";
export const AUTH_LOGOUT = "AUTH_LOGOUT";
export const AUTH_SET_KUBECONFIGS = "AUTH_SET_KUBECONFIGS";
export const AUTH_SET_GROUPS = "AUTH_SET_GROUPS";
